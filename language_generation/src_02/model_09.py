...
try:
    ...
    from model_utils_05 import Prompt_model
    from optimizer_07 import Adam16
    from GPT_02 import GPT, GPT_Tokenizer
except:
    from language_generation.src_02.settings_03 import model_name2path, model2hidden
    from language_generation.src_02.model_utils_05 import Prompt_model
    from language_generation.src_02.optimizer_07 import Adam16
    from language_generation.src_02.GPT_02 import GPT, GPT_Tokenizer
...
class Decoding_model:
    ...
    def train(self, train_dataset, valid_dataset, test_dataset=None):
        test_dataloader = DataLoader(test_dataset, batch_size = self.args['batch_size'], shuffle=False, num_workers=0) if test_dataset is not None else None
        train_dataloader = DataLoader(train_dataset, batch_size = self.args['batch_size'], shuffle=True, num_workers=0)
